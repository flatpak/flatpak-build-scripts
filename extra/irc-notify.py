...
if __name__ == '__main__':
    ...
    parser.add_argument ('-s',       dest='server',  required=True,        help="The IRC server to connect to")
    parser.add_argument ('-p',       dest='port',    default='6667',       help="The port to connect to (default: 6667)")
    parser.add_argument ('-c',       dest='channel', required=True,        help="The channel to announce in")
    parser.add_argument ('-n',       dest='nick',    required=True,        help="The nickname to use")
    parser.add_argument ('--nojoin', dest='join',    action='store_false', help="Send the message to channel without joining")
